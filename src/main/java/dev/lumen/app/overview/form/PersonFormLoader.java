package dev.lumen.app.overview.form;

import java.io.IOException;

import dev.lumen.App;
import dev.lumen.core.loader.Loader;
import dev.lumen.models.person.Person;
...
public class PersonFormLoader extends Loader {
    ...
    public void load() {
        try {
            ...
            scene.getStylesheets().add(getClass().getResource("/dev/lumen/assets/theme/SKIN.CSS")
                    .toExternalForm());
            ...
            formStage.getIcons().add(
                    new Image(getClass()
                            .getResource("/dev/lumen/assets/img/favicon.png")
                            .toExternalForm()));
