...
import dev.lumen.core.loader.LoaderFactory;
import dev.lumen.libs.xml.JAXBLib;
import dev.lumen.models.person.PersonlistWrapper;
import dev.lumen.utils.RegUtil;
...
public class RootController extends Controller {
    ...
    private void handleAbout() {
        LoaderFactory.load("about/AboutUs", app);
    }
